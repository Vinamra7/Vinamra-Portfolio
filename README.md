...
Typography and palette refinement: headings now use locally served Space Grotesk (OFL license included), with Manrope body text and IBM Plex Mono in the terminal. The intro greeting sits closer to the name and the role line is larger. Work card faces are almost black. Both star layers remain predominantly neutral, with 6% muted blue, 4% amber and 2% red stars. Commit 2753016 preserves the version immediately before these refinements.
